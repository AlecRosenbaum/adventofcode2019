...
from solution import calc_amplification, calc_amplification_feedback, solution_part_one, solution_part_two
...
def test_calc_amplification(program, phases, expected):
    state = calc_amplification(program, phases)
    assert [expected] == state.output
...
def test_calc_amplification_feedback(program, phases, expected):
    output = calc_amplification_feedback(program, phases)
